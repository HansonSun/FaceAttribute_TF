...
def inference(inputs,
    ...
    with tf.variable_scope(scope, 'vgg_16', [inputs]):
        with slim.arg_scope([slim.conv2d, slim.fully_connected],
            ...
            yaw=slim.conv2d(net, 68, [1, 1],activation_fn=None,normalizer_fn=None,scope='yaw_fc8')
            pitch=slim.conv2d(net, 68, [1, 1],activation_fn=None,normalizer_fn=None,scope='pitch_fc8')
            roll=slim.conv2d(net, 68, [1, 1],activation_fn=None,normalizer_fn=None,scope='roll_fc8')
